...
export const feedTypeEnum = pgEnum(
  'feed_type_enum',
  FEED_TYPE_KEYS as [string, ...string[]],
)
...
export const taskTypeEnum = pgEnum(
  'task_type_enum',
  TASK_TYPE_KEYS as [string, ...string[]],
)
...
export const userRoleEnum = pgEnum(
  'user_role_enum',
  USER_ROLE_KEYS as [string, ...string[]],
)
